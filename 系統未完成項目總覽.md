...
| 項目 | 位置 | 說明 |
|------|------|------|
| **人臉辨識為輕量替代** | `backend/app/tracking/face_insight.py:35` | 使用 HOG 特徵（128 維）替代 ArcFace，辨識品質較低。升級需加 InsightFace 依賴。 |
...
系統核心功能（MVP）已完成度約 **98%**。主要缺口在：

- **人臉辨識升級**：目前用 HOG 特徵（128 維），待整合 InsightFace ArcFace 深度學習模型
