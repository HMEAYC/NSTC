...
from app.tracking import face_insight
from app.report import advisor as edu_advisor, ai_edu
from app.tracking import identity
from app.tracking import longitudinal as student_longitudinal
from app.analysis import macro as macro_analytics, metrics as metrics_checker, micro as micro_analytics
from app.report.pdf import export_markdown_pdf
from app.paths import memory_dir, metrics_dir, reports_dir, tmp_dir
from app.timecode import format_mmss, parse_timecode
from app.ingest.video import load_audio_mono, read_video_meta
...
def run_full_pipeline(
    ...
    with tempfile.TemporaryDirectory(prefix="kinder-run-", dir=base_tmp) as run_tmp:
        ...
        if t0 is not None or t1 is not None:
            from app.ingest.segment import export_video_segment
